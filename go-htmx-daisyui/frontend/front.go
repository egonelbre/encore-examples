...
//
//encore:api public raw method=POST path=/htmx/shorten
func ShortenURL(w http.ResponseWriter, req *http.Request) {
	...
	result, err := url.Shorten(req.Context(), &url.ShortenParams{URL: rawURL})
	if err != nil {
...
// ListURLs returns the URL list as HTML fragments.
//
//encore:api public raw method=GET path=/htmx/urls
